       ...
       if( secilenBitmap != null){
           ...
           try {
               context?.let {
                   ...
                   database.execSQL("CREATE TABLE IF NOT EXISTS yemekler(id INTEGER PRIMARY KEY, yemekismi VARCHAR, yemekMalzemeleri VARCHAR, gorsel BLOB)")
                   val sqlString = "INSERT INTO yemekler (yemekismi, yemekMalzemeleri, gorsel) VALUES(?,?,?) "
